(function($) {
  ...
  $(function() {
    ...
    if ($("#transaction-history").length) {
      let localidades = $('.valor_localidad')
      var areaData = {
        labels: ["Ushuaia","Rio Grande","Tolhuin"],
        datasets: [{
            data: [localidades[0].innerHTML, localidades[1].innerHTML, localidades[2].innerHTML],
            backgroundColor: [
              "#0090e7","#ffab00","#fc424a"
            ]
          }
        ]
      };
